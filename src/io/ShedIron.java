...
/**
  ...
  */
   public double calcTotalOreWeight() 
   {
      ...
      fTotalOre = 0.0;
      for (OrePile pile : m_orePileQueue) {	// For this to work, Iterator must be implemented in io.DSAQueue
...
/**
  ...
  *
  * @return		An Iterator for this Shed (actually, io.DSAQueue's Iterator)
  */
